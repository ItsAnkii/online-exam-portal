...
%>
<a href="test_1.jsp" style="font-family:sans-serif;font-size: 22px;color:red;"> Give Test</a><br><br>
...
<fieldset style="font-family:sans-serif;color:blue;width:700px;height:350px;"><marquee direction="up" height="90%" scrolldelay="150" truespeed>
<%
while(rs.next())
{
	String fdd="";
